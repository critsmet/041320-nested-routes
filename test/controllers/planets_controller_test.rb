...
class PlanetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create planet" do
    assert_difference('Planet.count') do
      post planets_url, params: { planet: { galaxy: @planet.galaxy, moons: @planet.moons, name: @planet.name, temperature: @planet.temperature } }
    end
  ...
  test "should update planet" do
    patch planet_url(@planet), params: { planet: { galaxy: @planet.galaxy, moons: @planet.moons, name: @planet.name, temperature: @planet.temperature } }
